...
<head>
    <title>Ras Al Khor Wildlife Sanctuary | 360 degree Video Page</title>
...
<body >
    ...
    <div id="content"> <!--Content Begins -->
    	<div id="content-title">360<sup>o</sup> Video</div>
        <div id="content-text">
                                ...
                                <table width="500" border="0" cellspacing="0" cellpadding="0" id="m0" style="display:none;">
                                    <tr align="left">
                                      ...
                                      // -->
                                                    ...
                                                    <td>
                                                        ...
                                                        <noscript>
                                                            <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
                                                                ...
                                                                <param name="movie" value="Video3D.swf" />
                                                                <param name="quality" value="high" />
                                                                <param name='flashVars' value='myVideo=assets/rak2.flv'/>
                                                                <param name="bgcolor" value="#869ca7" />
                                                                <param name="allowScriptAccess" value="sameDomain" />
                                                                <embed src="Video3D.swf" quality="high" bgcolor="#869ca7"
                                                                       width="100%" height="100%" name="Video3D" align="middle"
                                            ...
                                            <table width="441" border="0" cellspacing="0" cellpadding="0" id="m3" style="display:none;">
                                                <tr>
                                                    <td>
                                                        ...
                                                        <script language="JavaScript" type="text/javascript">
                                                            ...
                                                            if ( hasProductInstall && !hasRequestedVersion ) {
                                                                ...
                                                                AC_FL_RunContent( 'id','Video3D','width','441','height','335','codebase','http://fpdownload.macromedia.com/get/flashplayer/current/swflash.cab','movie','Video3D','quality','high','flashvars','myVideo=assets/rak3.flv','bgcolor','#869ca7','allowscriptaccess','sameDomain' ); //end AC code
                                                            } else if (hasRequestedVersion) {
                                                                // if we've detected an acceptable version
                                                                // embed the Flash Content SWF when all Video3Ds are passed
                                                                AC_FL_RunContent(
                                                    ...
                                                    <td>
                                                        ...
                                                        <script language="JavaScript" type="text/javascript">
                                                            ...
                                                            if ( hasProductInstall && !hasRequestedVersion ) {
                                                                ...
                                                                "width", "441",
                                                                "height", "335",
                                                                "flashVars", "myVideo=assets/water-fin.flv",
                                                                "align", "middle",
                                                                "id", "Video3D",
                                                                "quality", "high",
                                                                "bgcolor", "#869ca7",
                                                    ...
                                                    <td>
                                                        ...
                                                        <script language="JavaScript" type="text/javascript">
                                                            ...
                                                            if ( hasProductInstall && !hasRequestedVersion ) {
                                                                ...
                                                                "width", "441",
                                                                "height", "335",
                                                                "flashVars", "myVideo=assets/lake-fin.flv",
                                                                "align", "middle",
                                                                "id", "Video3D",
                                                                "quality", "high",
                                                                "bgcolor", "#869ca7",
	...
	<div id="navigation-letf-title">360<sup>o</sup> Video</div><!--EOF navigation-left-title-->
 	<div id="navigation-letf-text">
    <p>This section contains unique Photint 360<sup>o</sup> interactive videos which place the user in control of their environment.</p>
    <p><span>Choose a video:</span></p>
     <table  border="0" cellspacing="5" cellpadding="3">
         <tr align="center" bgcolor="#0b263d">
            <th width="20px"><a href="#" onclick="javascript:m1();" onfocus="this.blur();" class="lt">1</a></th>
            <th width="20px"><a href="#" onclick="javascript:m2();" onfocus="this.blur();" class="lt">2</a></th>
            <th width="20px"><a href="#" onclick="javascript:m3();" onfocus="this.blur();" class="lt">3</a></th>
            <th width="20px"><a href="#" onclick="javascript:m4();" onfocus="this.blur();" class="lt">4</a></th>
            <th width="20px"><a href="#" onclick="javascript:m5();" onfocus="this.blur();" class="lt">5</a></th>
            <th width="20px"><a href="#" onclick="javascript:m6();" onfocus="this.blur();" class="lt">6</a></th>
           </tr>
     </table>
